...
let v11 = [];
console.log(v11, typeof v11); // 배열은 object타입
console.log(v11 instanceof Array);
let v12 = function(){};
console.log(v12, typeof v12); // function 타입
console.log(v12 instanceof Function);
let v13 = /abc/;
console.log(v13, typeof v13); // object 타입
console.log(v13 instanceof RegExp);

// typeof 연산자 : 리터럴의 타입을 반환
// instanceof 연산자 : 왼쪽 참조가 오른쪽의 타입인지 true또는 false 반환
