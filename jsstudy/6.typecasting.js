...
// 묵시적형변환 : 엔진이 상황(문맥, context)에 따라 자동적으로 형변환 (암묵적형변환)
...
// 단축 평가
// 논리합(||) 또는 논리곱(&&) 연산시 평가(연산에 필요한 계산)를 최대한 줄임
// 1. || : 왼쪽이 true면 오른쪽 패스
// 2. && : 왼쪽이 false면 오른쪽 패스
let v1 = true || "홍";
v1 = "홍" || true;
let v2 = false && "홍";
v2 = "홍" && false;
console.log("멍멍"||"야옹"); // 멍멍이 true, 야옹은 평가 x
console.log("멍멍"&&"야옹"); // 멍멍이 true, 야옹을 평가

// 옵셔널체이닝 (optional chaining) : ES11 (ES2020)
// ?. : 왼쪽이 null 또는 undefined 이면 undefined, 그렇지 않으면 오른쪽 수행
// null pointer 방지를 위해
let n = null;
