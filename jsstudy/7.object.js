...
// 객체는 0개 이상의 프라퍼티로 구성
// 프라퍼티는 프라퍼티명(키)과 프라퍼티값(벨류)로 구성
// js에서 객체는 연관배열 (Associative Array): key(인덱스)가 문자열인 배열
...
// 2. Object 생성자
// 객체리터럴로 객체를 생성해도 내부적으로 Object 생성자로 변환되어 해석
...
obj3.name = "홍길동"; // Function의 이름이라 읽기전용, 세팅이 안됨
obj3.age = 20;
obj3.address = "지구어딘가";
...
const person = new Person('홍길동',20,"지구어딘가");
console.log(person, typeof person);
console.log(person instanceof Person);
// Person은 Object를 상속받았다 (X) , 부모 자식 관계가 아님
...
// console.log(person2.like,person2.hobby);

const person2 = new Person('강감찬',50,'서울 어딘가');
person2.hobby = ["게임","등산"];
person2.printHobby();
for (prop in person){
...
// 방법 2
for (prop of Object.getOwnPropertyNames(obj1)){ //Object.getOwnPropertyNames(obj1) obj1의 프로퍼티들의 key값들의 배열을 반환
    console.log(prop, obj1[prop]);
}
