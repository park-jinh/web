...
// - JS는 소스코드를 실행컨텍스트에 따라 평가단계와 실행단계로 구분해 사용한다.
...
//   사용된다. 즉, 외부함수의 상태를 저장한 변수가 외부함수의 실행 종료
//   이후에도 사용될 수 있도록 하기위해 클로저를 사용합니다.
...
// 2. 지역변수 사용
//    num2의 값을 increase2만 변경할 수 있지만 증가가 되지 않는다.
...
// 3. 클로저 사용
//    num3의 값을 increase3만 변경할 수 있고 기능도 잘 작동한다
...
// 4. 클로저를 IIFE(즉시실행함수) 형식의 생성자함수로 표현
